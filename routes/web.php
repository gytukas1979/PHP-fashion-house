...
Route::group(['prefix' => 'masters'], function(){
    ...
    Route::put('update/{master}', [MasterController::class, 'update'])->name('master.update');
    Route::delete('delete/{master}', [MasterController::class, 'destroy'])->name('master.destroy');
...
Route::group(['prefix' => 'outfits'], function(){
    ...
    Route::put('update/{outfit}', [OutfitController::class, 'update'])->name('outfit.update');
    Route::delete('delete/{outfit}', [OutfitController::class, 'destroy'])->name('outfit.destroy');
